			...
			<div class="flex">
				...
				<div class="flex col">
					<div class="flex" id="barra_cima">
						<a class="flex logos_univ_aaue" href="http://www.uevora.pt/" target="_blank">
							<img src="<?php echo base_url()?>assets/imgs/uevora-logo.png" class="logo_barra_cima">
						</a>

						<a class="flex logos_univ_aaue" href="http://www.aaue.pt/" target="_blank">
							<img src="<?php echo base_url()?>assets/imgs/aaue-logo.png" class="logo_barra_cima">
						</a>

						<div class="flex social">
							<a href="https://www.instagram.com/aauevora/" target="_blank" class="icones_social">
								<img src="<?php echo base_url()?>assets/imgs/instagram.svg">
							</a>

							<a href="https://www.facebook.com/AAUEvora/" target="_blank" class="icones_social">
						...
						<div class="flex botoes_header">
							...
							<div class="botao_header dropdown" href="#">
								...
								<ul class="header-menu" aria-labelledby="torneio-masculino">
									<li>
										<a href="<?php echo base_url()?>index.php/calendario/">Resultados/<wbr>Classificações
										</a>
									</li>
									<li>
									...
									<li>
										<a href="<?php echo base_url()?>index.php/premios/">Prémios</a>
									</li>
								</ul>
							</div>
							...
							<div class="botao_header dropdown" href="#">
								...
								<ul class="header-menu" aria-labelledby="torneio-masculino">
									<li>
										<a href="https://drive.google.com/file/d/0BxZZnUa-6Wx9R29QTFZOeEsyZGs/view?usp=sharing" target="_blank">
							...
							<div class="botao_header dropdown" href="#">
								<a class="botao_header" href="<?php echo base_url()?>index.php/noticias/">
									<button class="header-dropdown" type="button"
